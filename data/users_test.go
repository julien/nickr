...
const fbURL = "https://nickr.firebaseio.com/tests/"
...
func TestNewUsers(t *testing.T) {
	u := NewUsers(fbURL + "test-new/users/")
	_, err := u.All()
	if err != nil {
		t.Errorf("error: %v\n", err)
	}
...
func TestAdd(t *testing.T) {
	u := NewUsers(fbURL + "test-add/users/")
...
func TestGet(t *testing.T) {
	...
	u := NewUsers(fbURL + "tests-get/users/")
...
func TestGetByName(t *testing.T) {
	...
	u := NewUsers(fbURL + "tests-get-by-name/users/")
...
func TestGetByID(t *testing.T) {
	...
	u := NewUsers(fbURL + "tests-get-by-id/users/")
...
func TestDelete(t *testing.T) {
	...
	u := NewUsers(fbURL + "tests-delete/users/")
